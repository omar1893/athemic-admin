...
const routes = [
  ...
  { path: '/pin-verification', name: 'pinVerification', component: () => import('./views/PinVerificationView.vue') },
  {
    ...
    children: [
      ...
      { path: 'orders/:id/:status', name: 'OrdenDetalle', component: OrdenDetalle, props: true},
      ...
      { path: 'stores', name: 'stores', component: () => import('./views/stores/index.vue') },
      { path: 'stores/create', name: 'storeCreate',  component: () => import('./views/stores/create.vue'), props: true },
      { path: 'stores/:id/edit', name: 'storesEdit', component: () => import('./views/stores/create.vue'), props: true },
